---
title: "The T-Knock Filter: Usage, Simulations, and Algorithms"
author: |
...
vignette: |
  ...
  %\VignetteIndexEntry{The T-Knock Filter: Usage, Simulations, and Algorithms}
...
<br>
<br>
```{r EnlargedPredictorMatrix, echo=FALSE, fig.cap="Figure 2: The enlarged predictor matrix (predictor matrix with dummies).", out.width = '100%'}
